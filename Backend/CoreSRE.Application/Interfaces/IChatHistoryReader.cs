...
public interface IChatHistoryReader
{
    ...
    /// </summary>
    /// <param name="agentName">Agent 名称（AgentSessionRecord.AgentId）</param>
    ...
    Task<JsonElement?> GetSessionDataAsync(string agentName, string conversationId, CancellationToken cancellationToken = default);
    ...
    /// <param name="conversationId">对话 ID（AgentSessionRecord.ConversationId）</param>
    /// <param name="cancellationToken">取消令牌</param>
    Task DeleteSessionAsync(string agentName, string conversationId, CancellationToken cancellationToken = default);
}
