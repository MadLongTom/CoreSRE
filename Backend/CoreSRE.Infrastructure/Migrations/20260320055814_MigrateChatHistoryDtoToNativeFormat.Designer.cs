...
namespace CoreSRE.Infrastructure.Migrations
{
    ...
    [Migration("20260320055814_MigrateChatHistoryDtoToNativeFormat")]
    partial class MigrateChatHistoryDtoToNativeFormat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoreSRE.Domain.Entities.AlertRule", b =>
                {
                    ...
                    b.Property<List<ContextInitItemVO>>("ContextProviders")
                        .IsRequired()
                        .HasColumnType("jsonb")
                            ...
                            b1.OwnsMany("CoreSRE.Domain.ValueObjects.DataSourceRefVO", "DataSourceRefs", b2 =>
                                {
                                    ...
                                    b2.Property<bool>("EnableMutations");
