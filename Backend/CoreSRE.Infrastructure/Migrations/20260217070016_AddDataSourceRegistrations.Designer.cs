...
namespace CoreSRE.Infrastructure.Migrations
{
    ...
    [Migration("20260217070016_AddDataSourceRegistrations")]
    partial class AddDataSourceRegistrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreSRE.Domain.Entities.AgentRegistration", b =>
                {
                    ...
                    b.Property<TeamConfigVO>("TeamConfig")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("CoreSRE.Domain.Entities.DataSourceRegistration", b =>
                {
                    b.OwnsOne("CoreSRE.Domain.ValueObjects.DataSourceConnectionVO", "ConnectionConfig", b1 =>
                        {
                            b1.Property<Guid>("DataSourceRegistrationId");

                            b1.Property<string>("AuthHeaderName");
                            ...
                            b1.Property<bool>("TlsSkipVerify");

                            b1.HasKey("DataSourceRegistrationId");

                            b1.ToTable("data_source_registrations");
                            ...
                            b1.WithOwner()
                                .HasForeignKey("DataSourceRegistrationId");
                        });

                    b.OwnsOne("CoreSRE.Domain.ValueObjects.DataSourceHealthVO", "HealthCheck", b1 =>
                        {
                            b1.Property<Guid>("DataSourceRegistrationId");
                            ...
                            b1.Property<DateTime?>("LastCheckAt");

                            b1.Property<int?>("ResponseTimeMs");
                    ...
                    b.OwnsOne("CoreSRE.Domain.ValueObjects.DataSourceMetadataVO", "Metadata", b1 =>
                        {
                            b1.Property<Guid>("DataSourceRegistrationId");

                            b1.PrimitiveCollection<string>("AvailableFunctions");

                            b1.Property<DateTime?>("DiscoveredAt");

                            b1.PrimitiveCollection<string>("Indices");

                            b1.PrimitiveCollection<string>("Labels");

                            b1.PrimitiveCollection<string>("Namespaces");

                            b1.PrimitiveCollection<string>("Services");
                    ...
                    b.OwnsOne("CoreSRE.Domain.ValueObjects.QueryConfigVO", "DefaultQueryConfig", b1 =>
                        {
                            b1.Property<Guid>("DataSourceRegistrationId");

                            b1.Property<string>("DefaultIndex");

                            b1.Property<Dictionary<string, string>>("DefaultLabels");

                            b1.Property<string>("DefaultNamespace");

                            b1.Property<string>("DefaultStep");
                    ...
                    b.Navigation("DefaultQueryConfig");
